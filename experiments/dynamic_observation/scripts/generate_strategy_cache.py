...
def get_combos_for_subset(subset: str) -> list[EnvAgentComboStorage]:
    ...
    # Use lib.database_utils for hard_small support
    try:
        sys.path.insert(0, str(Path(__file__).parent.parent))
        from lib.database_utils import get_combos_for_subset as _get_combos
        return _get_combos(subset)
    except ImportError:
        # Fallback to local implementation for hard/all
...
def main():
    ...
    parser.add_argument("--subset", type=str, default="hard", choices=["hard", "all", "hard_small"],
    ...
    parser.add_argument("--strategy-version", type=str, default="v1",
                        ...
                        help="Strategy version: v1 (13), v2 (10), v3 (12), v4 (49), or s5/s6/s8/s10/s20/s24/s48/s50/s100 (generated)")
