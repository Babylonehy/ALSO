...
- V5: 10 strategies optimized for adversarial bandit - sharper differentiation, sequential adaptation required
"""
...
# V5: Optimized for adversarial bandit - sharper differentiation, sequential adaptation required
# Total: 10 strategies (1 baseline + 9 active)
# Design principles:
# 1. Sharper differentiation - strategies have clear "home turf" where they excel
# 2. Sequential adaptation required - good performance needs online learning, not static generalization
# 3. Reduced "average effective" strategies - minimize strategies that work everywhere moderately
# 4. Context-dependent effectiveness - strategies that are polarized (very good or very bad depending on context)
SOCIAL_STRATEGIES_V5: list[dict[str, str]] = [
    # --- BASELINE ---
    {
        "id": "no_strategy",
        "name": "No Strategy (Baseline)",
    ...
    # --- HIGH-RISK HIGH-REWARD: Situation-specific strategies ---
    # These strategies are polarized: excellent in the right context, poor otherwise
    {
        "id": "aggressive_anchoring",
        "name": "Aggressive Anchoring",
        "theory": "Anchoring Bias + First Offer Advantage (Tversky & Kahneman 1974)",
        "description": (
            "In your response, make an aggressive first offer to anchor the negotiation. "
            "Set the anchor 30-50% beyond your target, then be prepared to concede. "
            "This strategy is highly effective when you have information advantage or when the other party "
            "is uncertain, but can backfire dramatically if they have a strong BATNA or market knowledge. "
            "Use phrases like 'Based on my assessment, a fair outcome would be...' then state your anchor. "
            "Be ready to justify with selective information."
        ),
    },
    {
        "id": "emotional_leverage",
        "name": "Emotional Leverage",
        "theory": "Emotional Intelligence + Affect Heuristic (Slovic et al. 2002)",
        "description": (
            "In your response, strategically use emotions to influence the other party. "
            "Express disappointment, frustration, or enthusiasm at key moments to shape their perception. "
            "This works exceptionally well in relationship-heavy scenarios, but can damage trust in "
            "transactional contexts. Say 'I have to admit, this situation has been really frustrating...' "
            "or 'I'm genuinely excited about what we could achieve together.' "
            "Gauge their emotional state and mirror or complement it strategically."
        ),
    },
    {
        "id": "information_asymmetry_exploit",
        "name": "Information Edge Strategy",
        "theory": "Information Asymmetry + Strategic Disclosure (Akerlof 1970)",
        "description": (
            "In your response, carefully control what information you reveal. "
            "Share information that supports your position while withholding or delaying unfavorable facts. "
            "Ask probing questions to gather their information. This strategy excels when you possess "
            "information the other party lacks, but fails when transparency is expected or required. "
            "Say 'Let me share something that might be relevant...' revealing selectively. "
            "Ask 'Could you help me understand your constraints better?' to extract information."
        ),
    },
    # --- CONTEXT-DEPENDENT: Requires recognition and adaptation ---
    {
        "id": "power_play",
        "name": "Power Dynamics Leverage",
        "theory": "Power in Negotiation (French & Raven 1959)",
        "description": (
            "In your response, leverage your position power, expertise, or alternatives to influence outcomes. "
            "This strategy is highly effective when you actually hold power, but creates resentment and "
            "relationship damage when used from a weak position. Say 'Given my options...' or 'As someone "
            "with experience in this area...' to establish credibility. Be careful: bluffing power when "
            "you lack it is a common failure mode. Works best when you have genuine leverage and the "
    ...
    },
    {
        ...
        "theory": "Relational Exchange Theory (Clark 1981)",
        "description": (
            "In your response, prioritize the relationship over immediate gains. "
            "Make investments in the relationship that may not pay off immediately. "
            "This strategy excels in ongoing relationships and trust-building scenarios, "
            "but is wasteful in one-shot transactions. Say 'I want to make sure we maintain "
            "a good relationship...' and 'What matters to you beyond this negotiation?' "
            "The payoff comes from future interactions, making this strategy patient but potentially "
            "inefficient for immediate outcomes."
        ),
    },
    {
        "id": "cultural_matching",
        "name": "Cultural Frame Matching",
        "theory": "Cultural Dimensions Theory (Hofstede 1980)",
        "description": (
            "In your response, adapt your communication style to match the other party's cultural frame. "
            "If they seem to value hierarchy, show respect and formality. If they value directness, be "
            "straightforward. This strategy requires reading cues and adapting—effective when matched "
            "correctly, jarring when mismatched. Pay attention to their communication patterns: "
            "indirect vs direct, formal vs informal, emotional vs reserved. Say 'I notice that...' "
            "and adapt accordingly. Works well in cross-cultural or diverse settings."
        ),
    },
    # --- SEQUENTIAL ADAPTATION: Requires trial and error ---
    {
        "id": "pattern_recognition_adapt",
        "name": "Pattern Recognition & Adapt",
        "theory": "Adaptive Decision Making + Pattern Recognition (Klein 1998)",
        "description": (
            "In your response, actively observe patterns in the other party's behavior and adapt. "
            "This is a meta-strategy that requires multiple rounds to be effective. "
            "In early turns, focus on gathering information and testing responses. "
            "Say 'I'm noticing a pattern here...' and 'Let me try a different approach.' "
            "The effectiveness grows as you accumulate observations, making this strategy "
            "uniquely suited for sequential adaptation. Poor performance in early rounds "
            "is expected—value emerges from learning."
        ),
    },
    {
        "id": "dynamic_concession_sizing",
        "name": "Dynamic Concession Sizing",
        "theory": "Negotiation Dynamics + Concession Patterns (Raiffa 1982)",
        "description": (
            "In your response, carefully size your concessions based on the other party's reactions. "
            "Start with small concessions, increase size if reciprocated, decrease if exploited. "
            "This strategy requires multiple rounds to calibrate. Say 'Let me make a gesture...' "
            "with a small initial concession, then 'I see you're willing to work with me...' "
            "to increase concessions, or 'I need to see more movement from your side...' "
            "to pull back. Effective when you have patience and the other party is cooperative."
        ),
    },
    {
        "id": "escalation_ladder",
        "name": "Escalation Ladder",
        "theory": "Escalation of Commitment + Strategic Tension (Staw 1976)",
        "description": (
            "In your response, strategically increase tension if progress stalls. "
            "Start cooperative, then escalate pressure if met with resistance, and de-escalate "
            "when progress resumes. This strategy is high-variance: can break deadlocks or "
            "destroy negotiations. Say 'I was hoping we could resolve this amicably...' "
            "before escalating, and 'I think we've found some common ground...' when de-escalating. "
            "Requires reading the situation correctly—misuse causes relationship damage."
        ),
    },
]

# V6: Optimized for hard subset based on empirical analysis
# Total: 10 strategies (1 baseline + 9 active)
# Design principles:
# 1. Based on hard subset performance analysis
# 2. pressure_tactics variants (best performer) are expanded
# 3. information_probe (good performer) is retained
# 4. Low performers (cost_benefit, normalize_disagreement) are removed
# 5. High-variance extreme strategies are added for adversarial advantage
SOCIAL_STRATEGIES_V6: list[dict[str, str]] = [
    # --- BASELINE ---
    {
        "id": "no_strategy",
        "name": "No Strategy (Baseline)",
    ...
    # === PRESSURE VARIANTS: Based on best performer (avg=3.75) ===
    {
        "id": "deadline_pressure",
        "name": "Deadline Pressure",
        "theory": "Scarcity Principle + Urgency (Cialdini 2006)",
        "description": (
            "In your response, create genuine urgency. Set a clear deadline or highlight "
            "time-sensitive nature of the decision. This strategy is highly effective when "
            "you have real constraints but risky if perceived as bluffing. Say 'I need to "
            "know by...' or 'This offer is only available until...' with specific, credible "
            "timeframes. Works best when the deadline is real and the other party has much "
            "to lose by missing it."
        ),
    },
    {
        "id": "batna_leverage",
        ...
        "theory": "Best Alternative to Negotiated Agreement (Fisher & Ury 1981)",
        "description": (
            "In your response, subtly signal your strong alternatives without directly "
            "revealing them. This creates negotiating leverage through implied power. "
            "Say 'I have other options I'm considering...' or 'I've been looking at "
            "alternatives...' to create pressure without ultimatums. Highly effective "
            "when you genuinely have good alternatives, but backfires if the bluff is called."
        ),
    },
    {
        "id": "extreme_anchor",
        ...
        "description": (
            "In your response, make an aggressive first offer that anchors the negotiation "
            "heavily in your favor. Set your anchor 50-100% beyond your actual target. "
            "This strategy has highest variance: either establishes extremely favorable "
            "terms or can terminate negotiations immediately. Use only when you have "
            "strong information advantage or when the relationship is secondary. "
            "Say 'Based on my assessment, fair value would be...' then state your extreme position."
        ),
    },
    # === INFORMATION STRATEGIES: Based on good performer (avg=3.40) ===
    {
        "id": "systematic_probe",
        "name": "Systematic Information Probe",
        "theory": "Information Gathering + Active Listening (Shapiro 2001)",
        "description": (
            "In your response, focus on gathering information before committing. "
            "Ask structured questions to understand the other party's true constraints, "
            "needs, and priorities. Say 'Help me understand...' and 'What matters most "
            "to you here?' Delay revealing your own position. This strategy builds "
            "information advantage but risks appearing evasive. Best in complex "
    ...
    },
    {
        ...
        "theory": "Strategic Information Management (Raiffa 1982)",
        "description": (
            "In your response, carefully control what you reveal. Share information "
            "that strengthens your position while keeping unfavorable facts private. "
            "Frame disclosures strategically: 'Let me share something that might help...' "
            "while holding back other details. Creates leverage through information "
            "asymmetry but can damage trust if discovered. Best in one-shot or "
            "transactional scenarios."
        ),
    },
    # === COOPERATIVE STRATEGIES: Balanced performers ===
    {
        "id": "integrative_frame",
        "name": "Integrative Framing",
        "theory": "Interest-Based Negotiation (Fisher & Ury 1981)",
        "description": (
            "In your response, reframe the negotiation from positions to interests. "
            "Shift from 'what I want' to 'why I want it' and help the other party do "
            "the same. Say 'What I really need is...' and 'Help me understand what's "
            "driving your position.' Creates opportunities for mutual gain but requires "
            "the other party to reciprocate. Works best in ongoing relationships."
        ),
    },
    {
        "id": "strategic_concession",
        "name": "Strategic Concession",
        "theory": "Reciprocity Norm (Gouldner 1960)",
        "description": (
            "In your response, make calculated concessions that trigger reciprocity. "
            "Offer small, visible concessions early to create obligation, then request "
            "equivalent returns. Say 'I'm willing to offer this as a gesture of good faith...' "
            "then pause for their response. Highly effective when the other party values "
            "fairness, but risky against purely competitive opponents."
        ),
    },
    # === EXTREME STRATEGIES: High variance for adversarial advantage ===
    {
        "id": "take_it_or_leave_it",
        "name": "Ultimatum Strategy",
        "theory": "Commitment Tactics + Final Offer (Schelling 1960)",
        "description": (
            "In your response, present your position as a final, non-negotiable offer. "
            "This strategy has extreme variance: either achieves maximum gains or "
            "terminates negotiations. Use only when you have significant leverage and "
            "are willing to walk away. Say 'This is my final offer. If it doesn't work, "
            "we're done.' Highest risk, highest reward. Best when you have strong BATNA."
        ),
    },
    {
        "id": "relationship_sacrifice",
        "name": "Relationship Sacrifice",
        "theory": "Competitive Negotiation + Zero-Sum Framing",
        "description": (
            "In your response, prioritize outcome over relationship. Push hard on "
            "your key interests, make minimal concessions, and accept that the "
            "relationship may suffer. Say 'I understand this might be difficult, but "
            "this is what I need.' High reward when relationship has no future value, "
            "damaging in ongoing interactions. Use strategically in one-shot scenarios."
        ),
    },
]

# Strategy pool size ablation variants (for rebuttal experiments)
# All subsets include baseline (no_strategy) + N active strategies

SOCIAL_STRATEGIES_V3_SIZE3: list[dict[str, str]] = [
    SOCIAL_STRATEGIES_V3[0],  # baseline
    SOCIAL_STRATEGIES_V3[1],  # collaborative_problem_solving
    SOCIAL_STRATEGIES_V3[2],  # altruistic_concession
    SOCIAL_STRATEGIES_V3[3],  # pressure_tactics
]

SOCIAL_STRATEGIES_V3_SIZE6: list[dict[str, str]] = [
    SOCIAL_STRATEGIES_V3[0],  # baseline
    SOCIAL_STRATEGIES_V3[1],  # collaborative_problem_solving
    SOCIAL_STRATEGIES_V3[2],  # altruistic_concession
    SOCIAL_STRATEGIES_V3[3],  # pressure_tactics
    SOCIAL_STRATEGIES_V3[4],  # feign_disinterest
    SOCIAL_STRATEGIES_V3[5],  # logical_tit_for_tat
    SOCIAL_STRATEGIES_V3[6],  # cost_benefit_persuasion
]

SOCIAL_STRATEGIES_V3_SIZE12: list[dict[str, str]] = (
    SOCIAL_STRATEGIES_V3  # All 13 (1 baseline + 12 active)
)
...
# For size 24 and 48, sample from V4 (49 strategies)
SOCIAL_STRATEGIES_V4_SIZE24: list[dict[str, str]] = SOCIAL_STRATEGIES_V4[
    :25
]  # baseline + 24 active
SOCIAL_STRATEGIES_V4_SIZE48: list[dict[str, str]] = SOCIAL_STRATEGIES_V4[:49]  # All V4


def _select_v4_strategies_by_ids(strategy_ids: list[str]) -> list[dict[str, str]]:
    """Select a fixed subset of V4 strategies while preserving order."""
    strategy_map = {strategy["id"]: strategy for strategy in SOCIAL_STRATEGIES_V4}
    return [strategy_map[strategy_id] for strategy_id in strategy_ids]


SOCIAL_STRATEGIES_V3_DIVERSE2_12: list[dict[str, str]] = [
    SOCIAL_STRATEGIES_V3[0],  # baseline
    *_select_v4_strategies_by_ids(
        [
            "validate_then_redirect",
            "validate_then_redirect_v1",
            "validate_then_redirect_v2",
            "validate_then_redirect_v3",
            "validate_then_redirect_v4",
            "validate_then_redirect_v5",
            "pressure_tactics",
            "pressure_tactics_v1",
            "pressure_tactics_v2",
            "pressure_tactics_v3",
...
SOCIAL_STRATEGIES_V3_DIVERSE4_12: list[dict[str, str]] = [
    SOCIAL_STRATEGIES_V3[0],  # baseline
    *_select_v4_strategies_by_ids(
        [
            "validate_then_redirect",
            "validate_then_redirect_v1",
            "validate_then_redirect_v2",
            "cost_benefit_persuasion",
            "cost_benefit_persuasion_v1",
            "cost_benefit_persuasion_v2",
            "feign_disinterest",
            "feign_disinterest_v1",
            "feign_disinterest_v2",
            "surface_hidden_concerns",
            "surface_hidden_concerns_v1",
            "surface_hidden_concerns_v2",
        ]
    ),
]

StrategyVersion = Literal[
    "v1",
    "v2",
    "v3",
    "v4",
...
def get_strategies(strategy_version: StrategyVersion = "v1") -> list[dict[str, str]]:
    ...
    Args:
        strategy_version: "v1" for SOCIAL_STRATEGIES (13 strategies)
            ...
            "v3" for SOCIAL_STRATEGIES_V3 (13 strategies, extended)
            "v3_size3" for 3-strategy subset
            "v3_size6" for 6-strategy subset
            "v3_size12" for 12-strategy subset (same as v3)
            "v3_diverse2_12" for 12 active strategies from 2 V3 parent families
            "v3_diverse4_12" for 12 active strategies from 4 V3 parent families
            "v4" for SOCIAL_STRATEGIES_V4 (49 strategies, V3 originals + semantic variants)
            "v4_size24" for 24-strategy subset from V4
            "v4_size48" for 48-strategy subset from V4
            "v5" for SOCIAL_STRATEGIES_V5 (10 strategies, adversarial-optimized)
            "v6" for SOCIAL_STRATEGIES_V6 (10 strategies, hard-optimized)
            "s6", "s24", "s48" for generated strategy spaces
    ...
    if strategy_version == "v3_diverse4_12":
        return SOCIAL_STRATEGIES_V3_DIVERSE4_12
    if strategy_version == "v3_diverse2_12":
        return SOCIAL_STRATEGIES_V3_DIVERSE2_12
    if strategy_version == "v4_size48":
        return SOCIAL_STRATEGIES_V4_SIZE48
    if strategy_version == "v4_size24":
        return SOCIAL_STRATEGIES_V4_SIZE24
    if strategy_version == "v3_size12":
        return SOCIAL_STRATEGIES_V3_SIZE12
    if strategy_version == "v3_size6":
        return SOCIAL_STRATEGIES_V3_SIZE6
    if strategy_version == "v3_size3":
        return SOCIAL_STRATEGIES_V3_SIZE3
    if strategy_version == "v6":
        return SOCIAL_STRATEGIES_V6
    if strategy_version == "v5":
        return SOCIAL_STRATEGIES_V5
...
def get_strategy_by_id(
    strategy_id: str, strategy_version: StrategyVersion = "v1"
) -> dict[str, str] | None:
...
def get_strategy_description(
    strategy_index: int, strategy_version: StrategyVersion = "v1"
) -> str:
...
def create_enhanced_bio(
    original_bio: str, strategy_index: int, strategy_version: StrategyVersion = "v1"
) -> str:
    """
...
def get_strategy_categories(
    strategy_version: StrategyVersion = "v3",
) -> dict[str, list[str]]:
    ...
    if strategy_version == "v4":
        ...
        return {
            ...
            "cooperative": [
                ...
                "collaborative_problem_solving_v1",
                "collaborative_problem_solving_v2",
                "collaborative_problem_solving_v3",
                "collaborative_problem_solving_v4",
                "collaborative_problem_solving_v5",
                "collaborative_problem_solving_v6",
                "collaborative_problem_solving_v7",
                "collaborative_problem_solving_v8",
                "altruistic_concession",  # original
                "altruistic_concession_v1",
                "altruistic_concession_v2",
                "altruistic_concession_v3",
                "altruistic_concession_v4",
                "altruistic_concession_v5",
                "altruistic_concession_v6",
                "altruistic_concession_v7",
                "altruistic_concession_v8",
            ],
            "competitive": [
            ...
            "strategic": [
                ...
                "feign_disinterest_v1",
                "feign_disinterest_v2",
                "feign_disinterest_v3",
                "feign_disinterest_v4",
                "feign_disinterest_v5",
                "feign_disinterest_v6",
                "feign_disinterest_v7",
            ],
            "rational": [
                "logical_tit_for_tat",  # original
                "logical_tit_for_tat_v1",
                "logical_tit_for_tat_v2",
                "logical_tit_for_tat_v3",
                "logical_tit_for_tat_v4",
                "logical_tit_for_tat_v5",
                "logical_tit_for_tat_v6",
                "logical_tit_for_tat_v7",
                "cost_benefit_persuasion",  # original
                "cost_benefit_persuasion_v1",
                "cost_benefit_persuasion_v2",
                "cost_benefit_persuasion_v3",
                "cost_benefit_persuasion_v4",
                "cost_benefit_persuasion_v5",
                "cost_benefit_persuasion_v6",
            ...
            "diplomatic": [
                ...
                "validate_then_redirect_v4",
                "validate_then_redirect_v5",
                "validate_then_redirect_v6",
                "validate_then_redirect_v7",
                "normalize_disagreement",  # original
                "normalize_disagreement_v1",
                "normalize_disagreement_v2",
                "normalize_disagreement_v3",
                "normalize_disagreement_v4",
                "normalize_disagreement_v5",
                "normalize_disagreement_v6",
                "normalize_disagreement_v7",
                "highlight_shared_stakes",  # original
                "highlight_shared_stakes_v1",
                "highlight_shared_stakes_v2",
                "highlight_shared_stakes_v3",
                "highlight_shared_stakes_v4",
                "highlight_shared_stakes_v5",
                "highlight_shared_stakes_v6",
                "highlight_shared_stakes_v7",
                "propose_incremental_steps",  # original
                "propose_incremental_steps_v1",
                "propose_incremental_steps_v2",
                "propose_incremental_steps_v3",
                "propose_incremental_steps_v4",
                "propose_incremental_steps_v5",
                "propose_incremental_steps_v6",
            ...
            "exploratory": [
                ...
                "surface_hidden_concerns_v1",
                "surface_hidden_concerns_v2",
                "surface_hidden_concerns_v3",
                "surface_hidden_concerns_v4",
                "surface_hidden_concerns_v5",
                "surface_hidden_concerns_v6",
                "surface_hidden_concerns_v7",
                "address_asymmetric_needs",  # original
                "address_asymmetric_needs_v1",
                "address_asymmetric_needs_v2",
                "address_asymmetric_needs_v3",
                "address_asymmetric_needs_v4",
                "address_asymmetric_needs_v5",
                "address_asymmetric_needs_v6",
    ...
    return {
        ...
        "diplomatic": [
            "validate_then_redirect",
            "normalize_disagreement",
            "highlight_shared_stakes",
            "propose_incremental_steps",
        ],
