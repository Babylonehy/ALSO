"""
Collection of mutation prompts and thinking styles for evolutionary bandits.
"""

# Default mutation prompts (from PromptBreeder paper - https://arxiv.org/pdf/2309.16797.pdf)
...
# Default thinking styles (from PromptBreeder paper - https://arxiv.org/pdf/2309.16797.pdf [pg. 21])
...
# =============================================================================
# Neural Evolution Mutation Prompts - Social Strategy Generation
# =============================================================================
# Optimized prompts for generating effective social strategies.
# Based on analysis of successful SOCIAL_STRATEGIES patterns:
# - Acknowledge conflicts/divergent interests
# - Propose collaborative solutions
# - Use advanced linguistic techniques (validation, reframing)
# - Maintain smooth conversation flow

NEURAL_EVOLUTION_MUTATION_PROMPTS = [
    # === Dimension 1: CONFLICT ACKNOWLEDGMENT ===
    "Modify this strategy to better acknowledge that goals may not fully align. Add language that tactfully recognizes tension without being confrontational, then proposes adjustments to bridge differing priorities.",
    "Enhance this strategy to surface hidden concerns. Add open-ended questions that invite the other party to reveal hesitations, then address these concerns directly.",

    # === Dimension 2: COLLABORATIVE REFRAMING ===
    "Reframe this strategy to transform opposition into shared challenges. Use phrases like 'I wonder if we might both benefit from...' to turn friction into collaborative problem-solving.",
    "Modify this strategy to emphasize mutual stakes. Illustrate what both parties stand to lose from disagreement, then pivot to showing how cooperation serves everyone better.",

    # === Dimension 3: VALIDATION AND REDIRECTION ===
    "Enhance this strategy with validation before redirection. Acknowledge the legitimacy of the other party's position, then smoothly transition with 'At the same time...' or 'Building on that...'",
    "Add conditional concession language to this strategy. Identify areas of flexibility and signal good faith with 'If I were to adjust X, would you be open to considering Y?'",

    # === Dimension 4: INCREMENTAL PROGRESS ===
    "Modify this strategy to propose smaller, low-risk steps when large agreements are blocked. Frame these as experiments that preserve options while building momentum.",
    "Enhance this strategy to address asymmetric needs. Propose creative arrangements that give each side more of what matters most to them.",

    # === Dimension 5: TENSION NORMALIZATION ===
    "Reframe this strategy to normalize disagreement. Use phrases like 'It makes sense that we see this differently...' to reduce defensiveness and create space for dialogue.",
    "Modify this strategy to focus on future resolution. Shift attention from current conflicts to desired outcomes with 'What would success look like for both of us?'",

    # === Dimension 6: GOAL EFFICIENCY ===
    "Enhance this strategy for efficient goal completion. When the primary goal is achieved, signal closure gracefully with appreciation and propose a natural exit point.",
    "Make this strategy more explicit about tradeoffs. Articulate what each party is giving up and gaining, then propose ways to rebalance for fairness.",
]

# =============================================================================
# Neural Evolution Thinking Styles - Social Strategy Optimization
# =============================================================================
# Strategic questions optimized for generating effective social strategies.
# Focus on conflict resolution, mutual benefit, and efficient goal achievement.

NEURAL_EVOLUTION_THINKING_STYLES = [
    # === Conflict Analysis ===
    "How can this strategy better acknowledge divergent interests while proposing bridges between differing priorities?",
    "What hidden concerns might the other party have? How can this strategy surface and address them?",

    # === Collaborative Framing ===
    "How can this strategy reframe opposition as a shared challenge rather than opposing positions?",
    "What mutual costs of disagreement can this strategy highlight to motivate cooperation?",

    # === Validation Techniques ===
    "How can this strategy validate the other party's position before introducing a different perspective?",
    "What conditional concessions could this strategy offer to signal good faith and invite reciprocity?",

    # === Progress Mechanisms ===
    "What smaller, low-risk steps could this strategy propose when large agreements are blocked?",
    "How can this strategy address asymmetric needs by giving each side more of what matters most?",

    # === Tension Management ===
    "How can this strategy normalize disagreement to reduce defensiveness and create dialogue space?",
    "How can this strategy shift focus from current conflicts to future outcomes both parties desire?",

    # === Efficiency and Closure ===
    "How can this strategy signal graceful closure when the primary goal has been achieved?",
    "What tradeoffs should this strategy make explicit to help both parties feel the exchange is fair?",
]

# PROMPT_BREEDER_MUTATION_PROMPTS = NEURAL_EVOLUTION_MUTATION_PROMPTS[:]
# PROMPT_BREEDER_THINKING_STYLES = NEURAL_EVOLUTION_THINKING_STYLES[:]
